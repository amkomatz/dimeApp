...
struct TemplateTransactionView: View {
    ...
    @AppStorage("numberEntryType", store: UserDefaults(suiteName: groupId)) var numberEntryType: Int = 1

    @Environment(\.colorScheme) var colorScheme

    @AppStorage("topEdge", store: UserDefaults(suiteName: groupId)) var topEdge: Double = 30
    ...
    @AppStorage("firstTransactionViewLaunch", store: UserDefaults(suiteName: groupId)) var firstLaunch: Bool = true
