...
struct SettingsNotificationsView: View {
  ...
  @AppStorage("notificationsEnabled", store: UserDefaults(suiteName: groupId))
  ...
  var body: some View {
    VStack {
      ...
      if showNotifications {
        ...
        .onAppear {
          if UserDefaults(suiteName: groupId)!.object(
            forKey: "notificationOption") != nil {
            option = UserDefaults(suiteName: groupId)!.integer(
              forKey: "notificationOption")
          }

          if UserDefaults(suiteName: groupId)!.object(forKey: "customHour")
            != nil
            && UserDefaults(suiteName: groupId)!.object(forKey: "customMinute")
              != nil {
            var components = DateComponents()
            components.hour = UserDefaults(suiteName: groupId)!.integer(
              forKey: "customHour")
            components.minute = UserDefaults(suiteName: groupId)!.integer(
              forKey: "customMinute")
...
func newNotification() {
  ...
  if UserDefaults(suiteName: groupId)!.object(forKey: "notificationOption")
    != nil {
    option = UserDefaults(suiteName: groupId)!.integer(
      forKey: "notificationOption")
  }
  ...
  if option == 1 {
    ...
    if UserDefaults(suiteName: groupId)!.object(forKey: "customHour") != nil,
      UserDefaults(suiteName: groupId)!.object(forKey: "customMinute") != nil {
      components.hour = UserDefaults(suiteName: groupId)!.integer(
        forKey: "customHour")
      components.minute = UserDefaults(suiteName: groupId)!.integer(
        forKey: "customMinute")
