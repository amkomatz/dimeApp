...
struct SettingsGoofyView: View {
  ...
  @AppStorage("confetti", store: UserDefaults(suiteName: groupId)) var confetti:
    Bool = false

  //    @AppStorage("chromatic", store: UserDefaults(suiteName: groupId)) var chromatic: Bool = false

  @AppStorage("logViewLineGraph", store: UserDefaults(suiteName: groupId))
  var lineGraph: Bool = false

  @AppStorage("budgetViewStyle", store: UserDefaults(suiteName: groupId))
  var budgetRows: Bool = false

  @AppStorage("swapTimeLabel", store: UserDefaults(suiteName: groupId))
