...
struct TransactionView: View {
    ...
    @AppStorage("topEdge", store: UserDefaults(suiteName: groupId)) var topEdge:
    Double = 20
    ...
    @AppStorage(
        "firstTransactionViewLaunch", store: UserDefaults(suiteName: groupId))
    ...
    @AppStorage(
        "showTransactionRecommendations", store: UserDefaults(suiteName: groupId))
