...
struct LogView: View {
    ...
    @AppStorage("showCents", store: UserDefaults(suiteName: groupId)) var showCents: Bool = true

    var topEdge: CGFloat

    @AppStorage("currency", store: UserDefaults(suiteName: groupId)) var currency: String = Locale.current.currencyCode!
    ...
    @AppStorage("logTimeFrame", store: UserDefaults(suiteName: groupId)) var logTimeFrame = 2
...
struct LogInsightsView: View {
    ...
    @AppStorage("logInsightsTimeFrame", store: UserDefaults(suiteName: groupId)) var timeframe = 2
    @AppStorage("logInsightsType", store: UserDefaults(suiteName: groupId)) var insightsType = 1

    @AppStorage("logViewLineGraph", store: UserDefaults(suiteName: groupId)) var lineGraph: Bool = false
    ...
    var range: Int {
        ...
        calendar.firstWeekday = UserDefaults(suiteName: groupId)?.integer(forKey: "firstWeekday") ?? 0
...
struct TimePickerView: View {
    ...
    @AppStorage("colourScheme", store: UserDefaults(suiteName: groupId)) var colourScheme: Int = 0
...
struct TransactionsList: View {
    ...
    @AppStorage("showUpcomingTransactions", store: UserDefaults(suiteName: groupId)) var showUpcoming: Bool = true
    @AppStorage("showUpcomingTransactionsWhenUpcoming", store: UserDefaults(suiteName: groupId)) var showSoon: Bool = false
...
struct ListView: View {
    ...
    @AppStorage("showExpenseOrIncomeSign", store: UserDefaults(suiteName: groupId))
    var showExpenseOrIncomeSign: Bool = true

    @AppStorage("swapTimeLabel", store: UserDefaults(suiteName: groupId)) var swapTimeLabel: Bool = false
...
struct DeleteTransactionAlert: View {
    ...
    @AppStorage("bottomEdge", store: UserDefaults(suiteName: groupId)) var bottomEdge: Double = 15
