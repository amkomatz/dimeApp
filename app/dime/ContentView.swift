...
struct ContentView: View {
    ...
    @AppStorage("showNotifications", store: UserDefaults(suiteName: groupId)) var showNotifications: Bool = false
    ...
    @AppStorage("dataMigration2", store: UserDefaults(suiteName: groupId)) var dataMigration2: Bool = true
    ...
    @AppStorage("topEdge", store: UserDefaults(suiteName: groupId)) var savedTopEdge: Double = 30
    @AppStorage("bottomEdge", store: UserDefaults(suiteName: groupId)) var savedBottomEdge: Double = 15

    // updateSheetShowing

    @AppStorage("previousVersion", store: UserDefaults(suiteName: groupId)) var previousVersionString: String = "Version \(UIApplication.appVersion ?? "") (\(UIApplication.buildNumber ?? ""))"

    @AppStorage("showUpdateSheet", store: UserDefaults(suiteName: groupId)) var showUpdateSheet: Bool = true
    ...
    var body: some View {
        ...
        .onAppear {
//            UserDefaults(suiteName: groupId)!.set(false, forKey: "newTransactionAdded")
